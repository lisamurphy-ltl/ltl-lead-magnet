...
Return: what created value, what wasted time, one operational leak, one decision before Monday, one leadership behavior to repeat, and a 5-sentence operating log summary.`,
  ...
  sales: {
    ...
    stack: [
      ...
      "A for-dummies, step-by-step build for each of the three — turned into a reusable project in your own AI (ChatGPT, Claude, or Gemini).",
    ...
    guide: "I've run the operation you're running — and rebuilt it so it runs without me.",
